...
private:
	...
	*/
    ...
    static void THReadingTimerEventHandler(AppEvent * aEvent);
    static void FunctionHandler(AppEvent * aEvent);
    static void LockActionEventHandler(AppEvent * aEvent);
    static void TimerEventHandler(TimerHandle_t xTimer);
    static void InitTHReadingHandler(TimerHandle_t xTimer);
    static void StartTHReadingEventHandler(AppEvent * aEvent);
