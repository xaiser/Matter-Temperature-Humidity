...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* InteractionModelVersion */         \
            ...
            { 0x0000, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(2) },      /* measured value */                                   \
            { 0x0001, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(0) },      /* min measured value */                               \
            ...
            { 0x0000, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0) },      /* measured value */                                   \
    ...
    {                                                                                                                              \
        { 0x0028,                                                                                                                  \
          ...
          chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                                                   \
            ...
            {                                                                                                                      \
                0x0402, ZAP_ATTRIBUTE_INDEX(104), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL                                             \
            }, /* Endpoint: 1, Cluster: Temperature Measurement (server) */                                                        \
            {                                                                                                                      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 11, 2326 }, { ZAP_CLUSTER_INDEX(11), 3, 19 },                                                      \
    }
...
#define ATTRIBUTE_MAX_SIZE (2345)
...
#define EMBER_AF_GENERATED_REPORTING_CONFIG_DEFAULTS                                                                               \
    {                                                                                                                              \
        ...
        {                                                                                                                          \
            ...
            /* Endpoint: 1, Cluster: Temperature Measurement (server) */                                                           \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0402, 0x0000, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65534, 1 } }      \
            }, /* measured value */                                                                                                \
                                                                                                                                   \
            /* Endpoint: 1, Cluster: Relative Humidity Measurement (server) */                                                     \
            {                                                                                                                      \
                ZAP_REPORT_DIRECTION(REPORTED), 0x0001, 0x0405, 0x0000, ZAP_CLUSTER_MASK(SERVER), 0x0000, { { 0, 65534, 1 } }      \
            }, /* measured value */                                                                                                \
    }
